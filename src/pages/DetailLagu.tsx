...
const DetailLagu = () => {
  ...
  return (
    <AppLayout>
      <div className="p-6 md:p-8 max-w-7xl min-h-[calc(100vh-3.5rem)]"
        ...
        <div className="mb-8 hyplayer-root">
          ...
          <div className="container mx-auto px-4">
            ...
            {/* Fixed audio controls on bottom */}
            <div id="hyplayer-controls" className="sticky bottom-0 bg-background/95 backdrop-blur supports-backdrop-filter:bg-background/60 border-t">
